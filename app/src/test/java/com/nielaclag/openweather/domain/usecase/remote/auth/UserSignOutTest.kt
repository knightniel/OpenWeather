...
class UserSignOutTest {
    ...
    private lateinit var userSignOut: UserSignOut
    ...
    fun setUp() {
        ...
        userSignOut = UserSignOut(authenticationRepository)
        moshi = Moshi
            .Builder()
    ...
    @Test
    fun invoke_should_return_successful() = runTest {
        val repositoryResponse = DataResponse.Success<Nothing, CustomError>(
            data = null,
